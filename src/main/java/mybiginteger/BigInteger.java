...
public class BigInteger
    ...
    private static BigInteger lucasLehmerSequence(int z, BigInteger k,
                                                  BigInteger n) {
    ...
    /**
     * Returns a positive BigInteger that is probably a secure prime, with the
     * specified bitLength. The certainity of the BigInteger returned being prime
     ...
     * @param rnd        source of random bits used to select candidates to be
     *                   tested for primality.
     * @return a BigInteger of <tt>bitLength</tt> bits that is probably a secure prime
     * @throws ArithmeticException <tt>bitLength &lt; 2</tt>.
     * @see #bitLength
     */
    public static BigInteger myProbableSecurePrime(int bitLength, int certainity, Random rnd) {
        if (bitLength < 2) {
            throw new ArithmeticException("bitLength < 2");
        }
     ...
     * The first value is the first solution of the equation ax = b (mod n), or ZERO
     * if there is no solution.
     * The second value gives the number of different solutions or ZERO if there is
     * no solution.
     *
     * @param a coefficient a of the equation.
     * @param b coefficient b of the equation.
     * @param n modulus of the equation.
     * @return an array of two BigIntegers.
     */
    public static BigInteger[] myModLinSolve(BigInteger a, BigInteger b, BigInteger n) {
        BigInteger[] ret = {ZERO, ZERO};
        return ret;
    }
    ...
    // Self-written additional methods
     ...
     */
    private void readObject(java.io.ObjectInputStream s) throws java.io.
     ...
     * the same as in method divide().
     */
    public BigInteger myDivide(BigInteger val) {
        return BigInteger.ZERO;
    }

    /**
     * New multiplication algorithm. Result and interface are supposed to be
     * the same as in method multiply().
     */
    public BigInteger myMultiply(BigInteger val) {
        return BigInteger.ZERO;
    }
    ...
    /**
     * Returns the square root of this mod p, if it exists and ZERO otherwise.
     */
     ...
     * Returns an integer factor of this, or ONE if this is prime.
     */
    public BigInteger myQuadraticSieve() {
        return BigInteger.ONE;
    }

    /**
     * Returns a BigInteger containing the discrete logarithm with base g of
     * this mod p
     *
     * @param g base of the discrete logarithm.
     * @param p modulus.
     * @return a BigInteger.
     */
    public BigInteger myModLog(BigInteger g, BigInteger p) {
        return ZERO;
    }

    /**
     * Addition algorithm for Elliptic Curves: Computes and returns
     * R = P+Q, where P=(this, P_y) and Q=(Q_x, Q_y) are the given elements of
     * the elliptic curve specified by the numbers p, a and b.
     */
    public BigInteger[] elliptAdd(BigInteger P_y,
                                  BigInteger Q_x,
                                  BigInteger Q_y,
                                  BigInteger p,
                                  BigInteger a,
    ...
    /**
     * Multiplication algorithm for Elliptic Curves: Computes and returns

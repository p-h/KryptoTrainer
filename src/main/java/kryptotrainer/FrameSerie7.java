...
// Panel 1
        ...
        jTextFieldEingabe.addActionListener(new
                FrameSerie7_jTextFieldEingabe_actionAdapter(this));
...
class FrameSerie7_jTextFieldEingabe_actionAdapter
        implements java.awt.event.ActionListener {
    FrameSerie7 adaptee;

    FrameSerie7_jTextFieldEingabe_actionAdapter(FrameSerie7 adaptee) {
        this.adaptee = adaptee;
    }

...
// Allgemeine Initialisierungen
        this.setSize(new Dimension(600, 576));
...
// Panel 1
        ...
        jTextFieldEingabeWert1.addActionListener(new
                FrameSerie9_jTextFieldEingabeWert1_actionAdapter(this));
        ...
        jTextFieldEingabeMod1.addActionListener(new
                FrameSerie9_jTextFieldEingabeMod1_actionAdapter(this));
...
// Panel 2
        ...
        jButtonStartC.addActionListener(new FrameSerie9_jButtonStartC_actionAdapter(this));
...
// ContentPane
    ...
    void jButtonStartA_actionPerformed(ActionEvent e) {
        ...
        // Ausgabe
        if (ausgabeWert1.equals(BigInteger.ZERO)) {
    ...
    void jButtonStartC_actionPerformed(ActionEvent e) {
        ...
        // Ausgabe
        if (ausgabeWert2.equals(BigInteger.ZERO)) {
...
class FrameSerie9_jTextFieldEingabeWert1_actionAdapter
        implements java.awt.event.ActionListener {
    FrameSerie9 adaptee;

    FrameSerie9_jTextFieldEingabeWert1_actionAdapter(FrameSerie9 adaptee) {
        this.adaptee = adaptee;
    }
...
class FrameSerie9_jTextFieldEingabeMod1_actionAdapter implements java.awt.event.ActionListener {
    FrameSerie9 adaptee;

    FrameSerie9_jTextFieldEingabeMod1_actionAdapter(FrameSerie9 adaptee) {
        this.adaptee = adaptee;
    }
...
class FrameSerie9_jButtonStartC_actionAdapter implements java.awt.event.ActionListener {
    FrameSerie9 adaptee;

    FrameSerie9_jButtonStartC_actionAdapter(FrameSerie9 adaptee) {
        this.adaptee = adaptee;
    }

...
// Panel 1
        ...
        jButtonStartA.addActionListener(new FrameSerie6_jButtonStartA_actionAdapter(this));
        ...
        jTextFieldSchluesselLaenge.addActionListener(new
                FrameSerie6_jTextFieldSchluesselLaenge_actionAdapter(this));
...
// Panel 2
        ...
        jButtonStartB.addActionListener(new FrameSerie6_jButtonStartB_actionAdapter(this));
        ...
        jTextFieldKlarText.addActionListener(new FrameSerie6_jTextFieldKlarText_actionAdapter(this));
...
// Panel 3
        ...
        jButtonStartC.addActionListener(new FrameSerie6_jButtonStartC_actionAdapter(this));
...
class FrameSerie6_jButtonStartB_actionAdapter
        implements java.awt.event.ActionListener {
    FrameSerie6 adaptee;

    FrameSerie6_jButtonStartB_actionAdapter(FrameSerie6 adaptee) {
        this.adaptee = adaptee;
    }
...
class FrameSerie6_jButtonStartA_actionAdapter
        implements java.awt.event.ActionListener {
    FrameSerie6 adaptee;

    FrameSerie6_jButtonStartA_actionAdapter(FrameSerie6 adaptee) {
        this.adaptee = adaptee;
    }
...
class FrameSerie6_jTextFieldSchluesselLaenge_actionAdapter
        implements java.awt.event.ActionListener {
    FrameSerie6 adaptee;

    FrameSerie6_jTextFieldSchluesselLaenge_actionAdapter(FrameSerie6 adaptee) {
        this.adaptee = adaptee;
    }
...
class FrameSerie6_jTextFieldKlarText_actionAdapter implements java.awt.event.ActionListener {
    FrameSerie6 adaptee;

    FrameSerie6_jTextFieldKlarText_actionAdapter(FrameSerie6 adaptee) {
        this.adaptee = adaptee;
    }
...
class FrameSerie6_jButtonStartC_actionAdapter implements java.awt.event.ActionListener {
    FrameSerie6 adaptee;

    FrameSerie6_jButtonStartC_actionAdapter(FrameSerie6 adaptee) {
        this.adaptee = adaptee;
    }

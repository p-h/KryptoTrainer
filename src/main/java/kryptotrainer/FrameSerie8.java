...
// Allgemeine Initialisierungen
        this.setSize(new Dimension(600, 416));
...
// Panel 1
        ...
        jButtonStopA.addActionListener(new FrameSerie8_jButtonStopA_actionAdapter(this));
...
class FrameSerie8_jButtonStopA_actionAdapter
        implements java.awt.event.ActionListener {
    FrameSerie8 adaptee;

    FrameSerie8_jButtonStopA_actionAdapter(FrameSerie8 adaptee) {
        this.adaptee = adaptee;
    }
